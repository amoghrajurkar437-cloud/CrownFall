...
def draw_objects(x, y, width, height, surface):
      #Tree drawing
   if width == 180 and height == 240:
      pygame.draw.rect(surface, (0, 255, 0), (x, y, width, height))
      #Rock drawing
      ...
      pygame.draw.rect(surface, (139, 69, 19), (x, y, width, height))
...
def draw_current_room(surface, level, row, col):
   ...
   #draw_objects(x, y, width, height, surface)
   #Tree = 180, 240
   #Rock = 100, 100
   #House = 300, 300
   #Wall = 150, 200
   ...
   if level == 0 and row == 0 and col == 0:
      ...
      draw_objects(450, 250, 300, 300, surface)
      draw_objects(225, 300, 180, 240, surface)
      draw_objects(25, 50, 100, 100, surface)
      draw_objects(175, 25, 100, 100, surface)
      draw_objects(600, 150, 25, 25, surface)
   elif level == 0 and row == 0 and col == 1:
      # Level 1 - Bottom-middle room
      draw_objects(350, 250, 100, 100, surface)
